...
export const POSTS = [
    ...
    },
    {
        ...
        Post2: 'Whilst a bit pricey, visiting London was the most amazing experience I have had to date! I recommend it to anyone from the US - we speak the same language, so its extremely easy to "get your feet wet" in the adventure that is overseas travel.'
    },
    {
        id: 3,
        title: 'Sydney',
        ...
        Post2: 'Even though it is home to more than 4 million people, I had no sense of the big city while there. People went out of their way to be friendly, helpful and courteous. The city itself has easily available restrooms, walking paths, shade areas, information booths and food! It was clean, calm and beautiful! The botanical garden was amazing! We would love to go back!'
